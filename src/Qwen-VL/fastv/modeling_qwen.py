            ...
            if self.gradient_checkpointing and self.training:
                ...
                if USE_FAST_V and FASTV_INPLACE:
                    ...
                    if i<AGG_LAYER:
                        ...
                        # keep index
                        keep_indexs = torch.cat( (torch.arange(SYS_LENGTH,device=device), top_attention_rank_index, torch.arange(SYS_LENGTH+IMAGE_TOKEN_LENGTH,kv_seq_len,device=device)))
                        # sort index
                        ...
                        rotary_pos_emb = [ i[:,keep_indexs,:,:] for i in rotary_pos_emb]
